...
public class CustomEPlayerRenderer extends EFrameBufferObjectRenderer implements SurfaceTexture.OnFrameAvailableListener {

    private static final String TAG = CustomEPlayerRenderer.class.getSimpleName();
    private final CustomEPlayerView glPreview;
    ...
    CustomEPlayerRenderer(CustomEPlayerView glPreview) {
        super();
