...
- (void)setLutFilterVideoComposition
{
    ...
    UIImage *filter = [UIImage imageNamed:_lutFilter];

    LutFilterHelper * lutFilterHelper = [LutFilterHelper new];
    ...
    _playerItem.videoComposition = [AVVideoComposition
                                    ...
                                    applyingCIFiltersWithHandler:^(AVAsynchronousCIImageFilteringRequest *_Nonnull request) {
                                        if (filter == nil) {
                                            ...
                                            [lutFilterHelper setFilterCIImageWithCiImage: request.sourceImage lut: filter];
                                            CIImage *output = [lutFilterHelper.lutFilteredImage imageByCroppingToRect: request.sourceImage.extent];
